...
The system includes all of the work from the past assessments, including temperature sensing, access verification, and vibration monitoring. The OLED display shows the current temperature, the accelerometer read-outs, whether or not the dump bed is open, and an 'ACCESS GRANTED' or 'ACCESS DENIED' to fit either RFID outcome.
...
The ESP32 hooked up to all of the components on Wokwi.

**Demo Video Link:**  
Video included in this submission folder
...
Everything is laid out into functions, making everything a bit more modular.
